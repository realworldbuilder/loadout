  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#111] rounded-lg border border-white/5 p-8 text-center">
          <CalendarIcon className="h-16 w-16 text-emerald-500 mx-auto mb-6" />
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">content calendar — launching soon</h2>
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">content scheduling</h3>
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">optimal timing</h3>
          <p className="text-gray-400 text-sm">
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">content themes</h3>
          <p className="text-gray-400 text-sm">
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">multi-format planning</h3>
          <p className="text-gray-400 text-sm">

    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#111] rounded-lg border border-white/5 p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">sales pipeline — launching soon</h2>
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">lead tracking</h3>
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">conversion analytics</h3>
          <p className="text-gray-400 text-sm">
        ...
        <div className="bg-white dark:bg-[#111] rounded-lg border border-white/5 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">revenue forecasting</h3>
          <p className="text-gray-400 text-sm">
